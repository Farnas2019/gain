...
app.get("/post/:id",function(req,res){
    ...
    Post.findById({_id}).populate("postedBy","likes").populate("comments.postedBy").exec().then(function(result){
...
app.put("/comment/:id", isLoggedin, function(req,res){
    ...
    Post.findByIdAndUpdate(req.params.id, {$push:{comments:comment}},{new:true}).populate("comments.postedBy").exec().then(function(result){
